...
global.owner = process.env.OWNER_NUMBER  || '254745188124' ;  // ADD YOUR NUMBER WITHOUT +
    
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=PNMW1YQC#N2ebYylJySxuDpGEsIY8AExKpZKyYniIaUCchuD7yLs' ,
travaSend: process.env.TRAVA_SEND || '25' ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'ᴾᴿᴳ∅☯𝕬〽🄾刀ᐺຖ²⁰²⁴' ,
